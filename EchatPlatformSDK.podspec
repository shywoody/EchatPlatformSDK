#
#  Be sure to run `pod spec lint EchatPlatformSDK.podspec' to ensure this is a
...
一洽多商户SDK,be happy,my friend
  ...
  spec.author             = { "shywoody" => "beatdoudou@163.com" }
  # Or just: spec.author    = "shywoody"
  # spec.authors            = { "shywoody" => "beatdoudou@163.com" }
  # spec.social_media_url   = "https://twitter.com/shywoody"
  ...
  spec.source       = { :git => "https://github.com/shywoody/EchatPlatformSDK.git", :tag => "#{spec.version}" }
